...
function header_cesare_benedetti_shortcode($atts) {
    ...
    <style>
        ...
        .cb-header-container ul,
        .cb-header-container ol {
            padding: 0;
            margin: 0;
            list-style: none;
        }

        .cb-header-container a {
            text-decoration: none;
            color: inherit;
        }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function adjustHeaderHeight() {
                ...
                const headerHeightDiv = document.getElementById("cb-header-height");
                if (headerHeightDiv) {
    ...
    <header class="cb-header-container ' . esc_attr($atts['custom_class']) . '">
        <div class="cb-header-content">
            ...
            <div class="cb-logo-text">
                <a href="' . esc_url($home_url) . '">APSP Cesare Benetti</a>
            </div>
